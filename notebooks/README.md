...
This should allow you to directly import `src/generativeinterface` in your notebook.
...
Run `python -m ipykernel install --user --name="generativeinterface"` from within your project environment to allow jupyter
to use your project's virtual environment. Afterwards a new kernel called generativeinterface should be available in the
